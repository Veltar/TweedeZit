...
@interface TweedeZitObject : KrollCoverageObject {
#else
@interface TweedeZitObject : KrollObject {
#endif
@private
...
extern NSString * TweedeZit$ModuleRequireFormat;
