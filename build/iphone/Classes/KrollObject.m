 ...
 * Copyright (c) 2009-2011 by TweedeZit, Inc. All Rights Reserved.
...
//@interface TweedeZitObject : NSObject
//@end

@interface TweedeZitObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TweedeZitObject class]])
		{
			for (NSString *key in [[(TweedeZitObject*)o modules] allKeys])
			{
