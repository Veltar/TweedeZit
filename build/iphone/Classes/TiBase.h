...
// in simulator we redefine to format for TweedeZit Developer console
...
{\
	NSString * exceptionName = [@"org.tweedezit." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tweedezit";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITweedeZitNativeItemNone = -1, 
	UITweedeZitNativeItemSpinner = -2,
	UITweedeZitNativeItemProgressBar = -3,
	
	UITweedeZitNativeItemSlider = -4,
	UITweedeZitNativeItemSwitch = -5,
	UITweedeZitNativeItemMultiButton = -6,
	UITweedeZitNativeItemSegmented = -7,
	
	UITweedeZitNativeItemTextView = -8,
	UITweedeZitNativeItemTextField = -9,
	UITweedeZitNativeItemSearchBar = -10,
	
	UITweedeZitNativeItemPicker = -11,
	UITweedeZitNativeItemDatePicker = -12,
	
	UITweedeZitNativeItemInfoLight = -13,
	UITweedeZitNativeItemInfoDark = -14,
	
	UITweedeZitNativeItemDisclosure = -15,
	
	UITweedeZitNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TweedeZit instances of
