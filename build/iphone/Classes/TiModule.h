...
/**
 The base class for all TweedeZit modules
 */
...
/**
 TweedeZit Platform calls this method on startup.
 */
-(void)startup;

/**
 TweedeZit Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 TweedeZit Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 TweedeZit Platform calls this method on resume.
 @param sender The sender of the event.
 */
